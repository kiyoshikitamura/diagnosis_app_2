            ...
            <div className="px-5 -mt-12 space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-[2.5rem] p-8 text-white text-center shadow-lg relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <a href="https://lin.ee/1e3TG7pg" className="flex items-center justify-center w-full py-4 bg-white text-green-600 rounded-2xl font-bold text-sm shadow-xl active:scale-95 transition-transform">
                            LINE公式アカウントを登録
                        </a>
                    </div>
